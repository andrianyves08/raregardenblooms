...
<p class="h4 mb-4">To</p>
  ...
  <!-- Password -->
  <input type="text" name="address" class="form-control mb-4" placeholder="Address" value="<?php echo ucwords($address);?>" readonly>
  ...
  <input type="number" min="0" name="contactNumber" class="form-control mb-4" placeholder="Phone Number" value="<?php echo $contactNumber;?>" readonly>
    ...
    <select class="browser-default custom-select" name="modeofpayment" id="modeofpayment" readonly>
      <option value="<?php echo $modeofpayment;?>">Cash</option>
    </select>
