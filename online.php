      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-12 mb-4">
          ...
          <div class="card">
            ...
            <!--Card content-->
            <div class="card-body">
              <form class="text-center" action="onlineSubmit.php" method="POST">
              <table id="dynamic_field" class="table table-striped table-bordered table-sm table-responsive item" cellspacing="0" width="100%">
                ...
                <tbody>
                  <tr>
                    ...
                    <td><input type="number" min="0" value="0" name="shippingprice[]" id="shippingprice_1" class="form-control" required/></td>
...
<form class="text-center">
 <p class="h4 mb-4">Remittance</p>

     <select id="two" class="browser-default custom-select" name="returningremittance">
      <option value="newremittance">New Remittance</option>
      <option value="0">No Remittance</option>
       <?php
  ...
  <input type="date" id="rremittanceDate" name="remittanceDate" class="form-control mb-4" placeholder="Date" required>
    ...
    <!-- Password -->
    <input type="text" id="rremittanceCode" name="remittanceCode" class="form-control mb-4" placeholder="Remittance Code" required>

    <input type="text" id="rremittanceAmount" name="remittanceAmount" class="form-control mb-4" placeholder="Remittance Amount" required>

      <input type="text" id="rremittanceCourier" name="remittanceCourier" class="form-control mb-4" placeholder="Courier" required>
...
<p class="h4 mb-4">To</p>
    ...
    <input type="date" name="shippingDate" id="date" class="form-control mb-4" placeholder="Date" required>
  ...
  <input type="text" name="trackingNumber" class="form-control mb-4" placeholder="Tracking Number" required>

  <input type="text" name="shippingCourier" class="form-control mb-4" placeholder="Courier" required>
        ...
        <div class="col-md-4">
          ...
          <div class="card">
            ...
            <div class="md-form">
              <i class="prefix">₱</i>
              <input type="number" id="totalshipping" name="totalshipping" class="form-control mb-4" placeholder="0" value="0">
          ...
          <div class="card">
            ...
            <div class="card-body">
                <label for="exampleFormControlTextarea1">Note:</label>
                    <textarea class="form-control rounded-0" name="note" rows="10"></textarea>
...
$(document).ready(function() {
  ...
  $('#two').change(function() {
    if( $(this).val() == 'newremittance') {
      ...
      $('#rremittanceDate').prop( "disabled", true );       
      $('#rfirstname').prop( "disabled", true );
      $('#rlastname').prop( "disabled", true );
      $('#raddress').prop( "disabled", true );
      $('#rcontactNumber').prop( "disabled", true );
      $('#rremittanceCourier').prop( "disabled", true );
      $('#rremittanceAmount').prop( "disabled", true );
      $('#rremittanceCode').prop( "disabled", true );
    } else {
      $('#rfirstname').prop( "disabled", true );
      $('#rlastname').prop( "disabled", true );
      $('#raddress').prop( "disabled", true );
...
$(document).ready(function(){
  ...
  $("[id^=shippingprice_]").keyup(function() {
    var sum = 0;
  $("[id^=shippingprice_]").each(function() {
        sum += Number($(this).val());
    });
  $('#totalshipping').val(sum);
  });
  ...
  $(document).on('blur', "[id^=shippingprice_]", function(){
    calculateTotal();
  });
...
function calculateTotal(){
  ...
  $("[id^='price_']").each(function() {
    ...
    var shippingprice = $('#shippingprice_'+id).val();
    var quantity  = $('#quantity_'+id).val();
    if(!quantity) {
      quantity = 1;
    }

    var total = (price*quantity)+ +shippingprice;
  ...
  var sales = (subTotal)- (totalshipping);
