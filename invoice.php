...
<body class="grey lighten-3">
  ...
  <li class="nav-item">
    <a class="nav-link" id="pills-profile-tab" data-toggle="pill" href="#pills-profile" role="tab"
      aria-controls="pills-profile" aria-selected="false">BCC</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="pills-contact-tab" data-toggle="pill" href="#pills-contact" role="tab"
      aria-controls="pills-contact" aria-selected="false">Inhouse</a>
  </li>
  <li class="nav-item">
    <a class="nav-link" id="pills-online-tab" data-toggle="pill" href="#pills-online" role="tab"
      aria-controls="pills-contact" aria-selected="false">Online</a>
  </li>
</ul>
...
<div class="text-center">
  <a href="" class="btn btn-primary btn-rounded mb-4" data-toggle="modal" data-target="#modalLoginForm">Add Invoice</a>
  </div>
</div><!--Container-->
  ...
  <div class="modal-dialog modal-sm" role="document">
    ...
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title w-100" id="myModalLabel">Choose Shop</h4>
      ...
      <div class="modal-body">
        <div class="row">
          <a href="bbc.php"><button type="button" class="btn btn-primary">BCC</button></a>
          <a href="inhouse.php"><button type="button" class="btn btn-secondary">Inhouse</button></a>
          <a href="online.php"><button type="button" class="btn btn-info">Online</button></a>
        </div>
      </div>
    </div>
  </div>
