      ...
      <div class="row wow fadeIn">
        ...
        <div class="col-md-12 mb-4">
          ...
          <div class="card">
            ...
            <!--Card content-->
            <div class="card-body">
              <form class="text-center" action="bbcSubmit.php" method="POST">
      ...
      <option value="1">Cash</option>
        ...
        <div class="col-md-4">
          ...
          <div class="card">
            ...
            <div class="md-form">
                <i class="prefix">₱</i>
                <input type="number" min="0" id="amountPaid" name="amountPaid" require class="form-control mb-4" value="0" required>
